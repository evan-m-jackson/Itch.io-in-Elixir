defmodule ItchCloneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ItchCloneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ItchCloneWeb.Gettext, "errors", msg, opts)
    end
  end
